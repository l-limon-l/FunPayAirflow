<h1 align="center">FunPay Airflow</h1>
...
- Создание плагинов для кастомизации функционала без редактирования исходного кода самого Airflow.
...
- Собственный Python-пакет FunPayAPI, который никак не привязан к FunPay Airflow.
...
2. Скачайте [FunPay Airflow](https://github.com/l-limon-l/FunPayAirflow/archive/refs/heads/master.zip)
3. Перенесите архив `FunPayAirflow-main.zip` в нужное Вам место и распакуйте его.
4. Перейдите в папку `FunPayAirflow-main`.
...
1. Выполните команду:
   `wget https://raw.githubusercontent.com/l-limon-l/FunPayAirflow/main/install-fpc.sh -O install-fpc.sh && bash install-fpc.sh`
...
Если вам удобно пользоваться FunPay Airflow, не забудьте поставить :star: звезду :star: данному проекту в правом
