...
def language_settings(c: Airflow) -> K:
...
def new_message_view_settings(c: Airflow) -> K:
    """
...
def greeting_settings(c: Airflow):
    """
...
def order_confirm_reply_settings(c: Airflow):
    """
...
def authorized_users(c: Airflow, offset: int):
    """
...
def authorized_user_settings(c: Airflow, user_id: int, offset: int, user_link: bool):
    """
...
def proxy(c: Airflow, offset: int, proxies: dict[str, bool]):
    """
...
def review_reply_settings(c: Airflow):
    """
...
def notifications_settings(c: Airflow, chat_id: int) -> K:
    """
...
def announcements_settings(c: Airflow, chat_id: int):
    """
...
def blacklist_settings(c: Airflow) -> K:
    """
...
def commands_list(c: Airflow, offset: int) -> K:
    """
...
def edit_command(c: Airflow, command_index: int, offset: int) -> K:
    """
...
def products_files_list(offset: int) -> K:
    ...
    for index, name in enumerate(files):
        amount = Utils.airflow_tools.count_products(f"storage/products/{name}")
...
def lots_list(cardinal: Airflow, offset: int) -> K:
    """
...
def funpay_lots_list(c: Airflow, offset: int):
    """
...
def edit_lot(c: Airflow, lot_number: int, offset: int) -> K:
    """
...
def templates_list(c: Airflow, offset: int) -> K:
    """
...
def edit_template(c: Airflow, template_index: int, offset: int) -> K:
    """
...
def templates_list_ans_mode(c: Airflow, offset: int, node_id: int, username: str, prev_page: int,
...
def plugins_list(c: Airflow, offset: int):
    """
...
def edit_plugin(c: Airflow, uuid: str, offset: int, ask_to_delete: bool = False):
    """
...
def LINKS_KB(language: None | str = None) -> K:
    return K().add(B(_("lnk_github", language=language),
                     url="https://github.com/sidor0912/FunPayAirflow")) \
