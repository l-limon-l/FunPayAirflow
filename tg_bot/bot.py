...
from Utils import airflow_tools, updater
...
class TGBot:
    def __init__(self, cardinal: Airflow):
    ...
    def reg_admin(self, m: Message):
        ...
        if not self.cardinal.block_tg_login and \
                airflow_tools.check_password(m.text, self.cardinal.MAIN_CFG["Telegram"]["secretKeyHash"]):
    ...
    def ban(self, m: Message):
        ...
        airflow_tools.cache_blacklist(self.cardinal.blacklist)
    ...
    def send_system_info(self, m: Message):
        ...
        self.bot.send_message(m.chat.id, _("sys_info", cpu_usage, psutil.Process().cpu_percent(),
                                           ...
                                           airflow_tools.time_to_str(uptime), m.chat.id))
    ...
    def edit_bot(self):
        ...
        sh_text = "🛠️ github.com/sidor0912/FunPayAirflow 💰 @sidor_donate 👨‍💻 @sidor0912 🧩 @fpc_plugins 🔄 @fpc_updates 💬 @funpay_cardinal"
